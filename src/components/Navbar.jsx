...
function Navbar() {
  ...
  return (
    <>
        <div className='bg-gray-200 flex justify-between px-8 md:px-10 lg:px-20 items-center'>
            <ul className='gap-3 lg:gap-5 items-center hidden md:flex'>
            ...
            <div className='md:hidden flex w-full justify-between items-center gap-3'>
              <img src={shopLogo} alt="Shop Logo" className='h-15 w-15' />
              <RxDragHandleHorizontal onClick={toggleHandle} className='text-3xl block' />  
            </div>
        </div>
