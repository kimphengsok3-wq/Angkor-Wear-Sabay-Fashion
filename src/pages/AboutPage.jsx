  ...
  return (
    <main className="w-full bg-white text-[#121212]">
      <section className="bg-[#E5E7EB] py-20 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto px-6 leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="w-20 h-1 bg-[#BA9242]"></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md transition">
              <div className="text-[#BA9242] text-3xl mb-4">✦</div>
